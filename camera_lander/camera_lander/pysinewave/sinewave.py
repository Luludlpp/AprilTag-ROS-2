...
class SineWave:
    ...
    def __init__(self, frequency=200, pitch_per_second=12, decibels=0, decibels_per_second=1, channels=1, channel_side="lr",
                samplerate=utilities.DEFAULT_SAMPLE_RATE):
        
        

        self.sinewave_generator = sinewave_generator.SineWaveGenerator(
                                    frequency=frequency, pitch_per_second=pitch_per_second,
